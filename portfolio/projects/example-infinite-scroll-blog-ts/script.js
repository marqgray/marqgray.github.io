...
var app = new (/** @class */ (function () {
    ...
    class_1.prototype.filterPosts = function (e) {
    ...
    class_1.prototype.getPosts = function () {
    ...
    class_1.prototype.showPosts = function () {
        return __awaiter(this, void 0, void 0, function () {
            var posts;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        posts.forEach(function (post) {
                            ...
                            _this.htmlElements.postsContainer.appendChild(postElement);
                        });
                        return [2 /*return*/];
                }
            });
    ...
    class_1.prototype.showLoading = function () {
        var _this = this;
        this.htmlElements.loading.classList.add("show");
        setTimeout(function () {
            _this.htmlElements.loading.classList.remove("show");
            setTimeout(function () {
                _this.page++;
                _this.showPosts();
            }, 300);
